      ...
      <div className="shell space-y-8">
        <div className="grid gap-6 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
          <div className="space-y-5">
            ...
            <h1 className="max-w-2xl text-[40px] font-bold leading-[1.08] tracking-[-0.05em] lg:text-[56px]">
              {hero ? hero.title : SITE_COPY.heroTitle}
            </h1>
            <p className="max-w-xl text-base leading-8 text-white/76 sm:text-lg">
              {hero ? hero.summary : SITE_COPY.heroDescription}
            </p>
          ...
          {hero ? (
            ...
            <div className="rounded-[32px] border border-white/10 bg-white/6 p-6">
              ...
              <p className="mt-3 text-sm leading-7 text-white/72">
                학년별로 빠르게 이동하면 우리 아이에게 맞는 콘텐츠를 더 쉽게 찾을 수 있습니다.
              </p>
            </div>
          )}
        </div>
